...
<?php
 session_start();
                             echo   $varowner=$_SESSION['Id'];
                             echo   $varreal=$_SESSION['cid'];
                        ...
                        <div class="widget-body">                          
                            ...
                            <thead>
                                <tr>
                                     ...
                                     <th class="hidden-phone"><?php GetProperty('writingdate',$_SESSION['rtl']);?></th>
                                     <th class="hidden-phone"><?php GetProperty('rentstartdate',$_SESSION['rtl']);?></th>
                                     <th class="hidden-phone"><?php GetProperty('endcontract',$_SESSION['rtl']);?></th>
                                     <th class="hidden-phone"><?php GetProperty('durationcontract',$_SESSION['rtl']);?></th>
                                     <th class="hidden-phone"><?php GetProperty('schudle_month',$_SESSION['rtl']);?></th>
                                </tr>
                            </thead>
                                   <tbody>
                               <?php
