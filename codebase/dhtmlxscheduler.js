...
window.dhtmlXScheduler = window.scheduler = {
    ...
    function() {
        ...
        this._obj.onselectstart = function(e) {
            ...
            scheduler._temp_touch_block || scheduler._on_mouse_move( e.preventDefault()
)
        }, this._obj.onmousedown = function(e) {
            scheduler._ignore_next_click || scheduler._on_mouse_down( e.preventDefault()
)
        }, this._obj.onmouseup = function(e) {
            scheduler._ignore_next_click || scheduler._on_mouse_up( e.preventDefault()
)
        }, this._obj.ondblclick = function(e) {
            scheduler._on_dbl_click( e.preventDefault()
)
...
//this.config.left_border && (d -= 1, r.className += " dhx_scale_hour_border"), r.style.width = d + "px", r.innerHTML = scheduler.templates.hour_scale(a), s.appendChild(r), a = this.date.add(a, 1, "hour")
    ...
    function() {
        for (var e = ["property_name", "Text1","unit", "Text", "start_date", "StartDate", "end_date", "EndDate"], t = function(e) {
                return function(t) {
        ...
        m += '<div class="dhx_event_move dhx_title" style="' + u + g + '">' + r + "</div>",
        m += '<div class="dhx_body" style=" width:' + (s - (this._quirks ? 4 : 14)) + "px; height:" + (a - (this._quirks ? 20 : 30) + 1) + "px;" + u + g + '">The Unit No '+ d + " Will Expire</div>";
        m += '<div class="dhx_body" style=" width:' + (s - (this._quirks ? 4 : 14)) + "px; height:" + (a - (this._quirks ? 20 : 30) + 1) + "px;" + u + g + '">The Unit No '+ d + " Will Expire</div>";
        ...
        if (n) {
            ...
            (!e._timed || d) && (u = "dhx_cal_event_line"), l && (u += " dhx_cal_event_line_start"), h && (u += " dhx_cal_event_line_end"),
                _ && (r += "<div class='dhx_event_resize dhx_event_resize_start'></div>"), c &&
                 (r += "<div class='dhx_event_resize dhx_event_resize_end'></div>");
            var g = scheduler.templates.event_class(e.start_date, e.end_date, e,e);
            g && (u += " " + g);
            ...
            d && (p += r), "month" == scheduler.getState().mode && (e = scheduler.getEvent(e.id)),
                e._timed && (p += scheduler.templates.event_bar_date(e.start_date, e.end_date, e)),
                 p += scheduler.templates.event_bar_text(e.start_date, e.end_date, e) + "</div>", p += "</div>",
                  o.innerHTML = p, this._rendered.push(o.firstChild), t.appendChild(o.firstChild)
        }
    ...
    function() {
        ...
        scheduler.attachEvent("onSchedulerReady", function() {
            scheduler.config.delay_render ? (scheduler.setCurrentView = n) : (scheduler.setCurrentView = t)
        })
    }();
